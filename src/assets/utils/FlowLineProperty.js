...
// 定义线的轨迹动态线纹理-->
function PolylineTrailLinkMaterialProperty(color, duration, repeat, type) {
...
PolylineTrailLinkMaterialProperty.prototype.equals = function(other) {
    return this === other || (other instanceof PolylineTrailLinkMaterialProperty && Cesium.Property.equals(this._color, other._color) && Cesium.Property.equals(this._repeat, other._repeat));
};
...
Cesium.Material._materialCache.addMaterial(Cesium.Material.PolylineTrailLinkType, {
    fabric: {
        ...
        uniforms: {
            ...
            image: require('@/assets/imgs/changjiangwater.png'),
            // image: '',
            time: 0,
            repeat: 5.0
        },
