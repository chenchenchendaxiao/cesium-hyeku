<template>
    <div>
        <canvas id="webgl3" width="300" height="300"  style="left: 600px;background-color: rgb(17, 146, 185);position: absolute;z-index: 999;top:0;"></canvas>
    </div>
</template>
<script>
export default {
    methods:{
        webGlInit() {
            var canvas=document.getElementById('webgl3');
